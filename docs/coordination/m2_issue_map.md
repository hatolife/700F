...
ISSUE-0029 through ISSUE-0031 are integrated locally. ISSUE-0034 is complete as
a guarded research checkpoint, with direct F700F Codec2 runtime linkage still
deferred. ISSUE-0032, ISSUE-0033, and ISSUE-0035 remain startable in priority
order, but real candidate downselect remains prohibited until
surrogate/emulator/official semantics are explicit in reports.
