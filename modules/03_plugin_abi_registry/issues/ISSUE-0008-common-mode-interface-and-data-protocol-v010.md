...
## Scope
module:03_plugin_abi_registry

## Priority
P0

## Owner
- Codex role: Module 03
...
- Required cases: descriptor fields and registry/factory behavior needed by the future C ABI plugin boundary.
- Red command: `cmake -S . -B build -DCMAKE_BUILD_TYPE=Debug && cmake --build build && ctest --test-dir build --output-on-failure`
- Expected failure before implementation: confirmed under bash; public Mode registry/factory symbols and protocol docs do not exist yet.

## Work log
- 2026-06-27 00:00 UTC Created by Manager Codex during M1 issue expansion.
- 2026-06-27 23:40 JST Subagent C began ISSUE-0008 plugin-protocol documentation and C++ registry contract work.
- 2026-06-28 00:05 JST Completed local v0.1.0 registry/plugin protocol contract with passing `bash ./tools/run_ci_local.sh`.
