...
- Downselect feasibility: Real downselect possible: no; surrogate, waveform-prototype, skipped, profile-only, descriptor-only, emulated-surrogate, or failed rows prevent real downselect.
...
| `freedv700f_a_balanced` | 0 | 3 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 3 | 0 | 0 | waveform_prototype | WAVEFORM PROTOTYPE WARNING: prototype=true not_final_modem=true downselect_valid=false performance_valid=false |
...
- `freedv700f_a_balanced` waveform_prototype real score 0 surrogate readiness 0 prototype=true not_final_modem=true waveform_capable=true downselect_valid=false performance_valid=false modem_family=toy_audio_waveform
...
- Real downselect possible: no; surrogate, waveform-prototype, skipped, profile-only, descriptor-only, emulated-surrogate, or failed rows prevent real downselect.
...
- WAVEFORM PROTOTYPE WARNING: 700F prototype rows are experimental readiness evidence only; prototype=true; not_final_modem=true; downselect_valid=false; performance_valid=false.
